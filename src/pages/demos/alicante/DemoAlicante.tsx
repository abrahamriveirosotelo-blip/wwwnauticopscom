...
function TimeField({ label, value, isReal, isEmpty }) {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 3 }}>
      <div style={{ fontSize: 9, fontWeight: 800, color: B.gray, letterSpacing: "0.07em" }}>
        {label}
      </div>
      <div
        style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        <div
          style={{
            ...
            fontSize: 9,
            fontWeight: 800,
            background: done ? B.navy : B.grayLight,
            color: done ? B.cyan : B.gray,
          }}
        >
          {code}
        </div>
        {!last && (
          <div
            style={{
              width: 2,
              height: 18,
              background: done ? B.cyan : B.grayLight,
              marginTop: 2,
              borderRadius: 1,
            }}
          />
          ...
          {real ? (
            <span
              style={{
                fontSize: 11,
                fontWeight: 700,
                color: isLate ? B.danger : B.success,
...
function Detail({ call, onClose }) {
  const primaryCall =
    CALLS.find((c) => c.status === "Alerta") || CALLS.find((c) => c.status === "Iniciado");
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          background: isAlert ? "#7F1D1D" : B.navy,
          padding: "20px 24px",
          color: B.white,
          flexShrink: 0,
      ...
      >
        {isAlert && (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span
                style={{ fontSize: 11, fontWeight: 800, color: "#FCA5A5", letterSpacing: "0.06em" }}
              >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            ...
            <div style={{ fontSize: 22, fontWeight: 800, marginTop: 3, letterSpacing: "-0.01em" }}>
              {call.name}
            </div>
      ...
      <div
        style={{
          display: "flex",
          borderBottom: `2px solid ${B.grayLight}`,
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              >
                    ...
                    {(() => {
                      const ata =
                        call.status !== "Prevista"
                          ? fmt(new Date(new Date(call.eta).getTime() + 25 * 60000))
                          : null;
                      return (
                        <TimeField
                          label="ATA · Llegada real"
                          value={ata || "—"}
                          isReal={true}
                          isEmpty={!ata}
                        />
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0 }}>
                  ...
                  <div style={{ padding: "14px 16px" }}>
                    <TimeField label="ATD · Salida real" value="—" isReal={true} isEmpty={true} />
                  </div>
                </div>
              </div>
            </div>
                      ...
                      >
                        ...
                        <div style={{ textAlign: "right", flexShrink: 0 }}>
                          {m.time ? (
                            ...
                            <div style={{ fontSize: 10, color: B.grayLight, fontWeight: 600 }}>
                              Pendiente
                            </div>
                          )}
                        </div>
                ...
                {[
                  {
                    ...
                    label: "Entrada",
                    from: "Mar",
                    to: `Muelle ${call.berth}`,
                    done: call.status !== "Prevista",
                  },
                  {
                    tipo: "S",
                    label: "Salida",
                    from: `Muelle ${call.berth}`,
                    to: "Mar",
                    done: false,
                  },
                ].map((m) => (
                  ...
                  >
                    ...
                    <span
                      style={{
                        ...
                        fontWeight: 800,
                        letterSpacing: "0.05em",
                        color: m.done ? B.success : B.warning,
                      }}
                    >
                      {m.done ? "EJECUTADO" : "PREVISTO"}
                    </span>
                  </div>
                ))}
              </div>
              ...
              <div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: B.gray, marginTop: 2 }}>
                        Parte nº 027892 · {TUG.powerPct}% potencia
                      </div>
                    </div>
                    <span
                      style={{
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8 }}>
                    {[
                      ["Patrón", TUG.crew.patron],
                      ["Mecánico", TUG.crew.mecanico],
                      ["Marinero", TUG.crew.marinero],
                    ].map(([r, n]) => (
                      <div
                        key={r}
                        style={{
                      ...
                      >
                        ...
                        <div style={{ fontSize: 12, color: B.navy, fontWeight: 700, marginTop: 2 }}>
                          {n}
                        </div>
                      </div>
                    ))}
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontSize: 13, fontWeight: 700, color: B.navy }}>
                    Parte de remolque nº 027892
                  </div>
                  <div style={{ fontSize: 11, color: B.gray }}>
                    Recibido vía WhatsApp · 11/05/2026 · OCR completado
                  </div>
                </div>
                <span
                  style={{
...
export default function App() {
  ...
  const filtered = CALLS.filter((c) => {
    ...
    const mf =
      filter === "Todas" ||
      (filter === "Iniciado" && (c.status === "Iniciado" || c.status === "Alerta")) ||
      (filter === "Alerta" && c.status === "Alerta") ||
      (filter === "Prevista" && c.status === "Prevista");
    return ms && mf;
  });
      ...
      <div style={{ padding: "20px 24px" }}>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 11, color: "rgba(252,165,165,0.8)", marginTop: 2 }}>
                    ...
                    {affectedNames &&
                      ` · ${affectedNames} potencialmente afectada${affected.length > 1 ? "s" : ""}`}
                  </div>
                </div>
                <button
                  onClick={() => setSelected(alertCall)}
                  style={{
                    marginLeft: "auto",
                    background: "rgba(239,68,68,0.2)",
                    border: `1px solid ${B.danger}`,
        ...
        <div
          style={{
            ...
            border: `1px solid ${B.grayLight}`,
            overflow: "hidden",
            boxShadow: "0 1px 6px rgba(1,11,36,0.06)",
          }}
        >
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            ...
            <tbody>
              {filtered.map((c, i) => {
                ...
                const affectRisk =
                  c.affectRisk === "ALTO"
                    ? { label: "Impacto ALTO", color: "#DC2626", bg: "#FEE2E2" }
                    : c.affectRisk === "MEDIO"
                      ? { label: "Impacto MEDIO", color: "#D97706", bg: "#FEF3C7" }
                      : null;
                return (
                  <tr
                    key={c.id}
                    ...
                    onMouseLeave={(e) => {
                      if (!isSel)
                        e.currentTarget.style.background = isAl
                          ? "#FFF1F1"
                          : isAffected
                            ? "#FFFBEB"
                            : i % 2 === 0
                  ...
                  >
                    ...
                    <td style={{ padding: "11px 14px" }}>
                      <div
                        style={{ fontWeight: 800, fontSize: 13, color: isAl ? B.danger : B.navy }}
                      >
                        {c.name}
                      </div>
                      <div
                        ...
                        {isAffected && affectRisk && (
                          <span
                            style={{
                              ...
                              fontSize: 9,
                              fontWeight: 800,
                              background: affectRisk.bg,
                              color: affectRisk.color,
                              letterSpacing: "0.04em",
                            }}
                          >
                            ⚠ {affectRisk.label}
                    ...
                    <td
                      style={{ padding: "11px 14px", fontSize: 12, color: B.gray, fontWeight: 600 }}
                    >
                      {c.gt.toLocaleString()}
                    </td>
                    <td style={{ padding: "11px 14px" }}>
                      <span
                        style={{
                          ...
                          fontSize: 12,
                          fontWeight: 800,
                          color: isAffected ? B.warning : B.navy,
                        }}
                      >
                        {c.berth}
                      </span>
                    ...
                    <td
                      style={{ padding: "11px 14px", fontSize: 10, color: B.gray, maxWidth: 160 }}
                    >
                      <div
                        style={{
                          overflow: "hidden",
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <Logo size={22} />
            <span style={{ fontSize: 9, color: B.gray, fontWeight: 700, letterSpacing: "0.03em" }}>
              ×
            </span>
            <LogoAPA height={16} />
          </div>
          <span
            style={{ fontSize: 10, color: B.gray }}
          >{`${META.source} · Actualización cada ${META.refreshHours}h`}</span>
        </div>
      </div>
