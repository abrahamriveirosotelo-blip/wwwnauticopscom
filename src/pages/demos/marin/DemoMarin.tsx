...
type Meta = { port: string; source: string; date: string; refreshHours: number; sourceUpdatedAt?: string; meteo?: Meteo };
type Call = {
  id: string; name: string; status: string;
  imo?: string; gt?: number; len?: number; beam?: number; dwt?: number;
  berth?: string; agent?: string; op?: string; eta?: string; etd?: string; from?: string; to?: string;
  mmsi?: string; detailId?: string; flag?: string; vesselType?: string; built?: number; callsign?: string; norays?: string;
  aisStatus?: string; aisEta?: string; aisSpeed?: number; aisDraught?: number; aisDestination?: string; aisAt?: string;
  aisAtMarin?: boolean; aisToFinal?: boolean; aisArrivedMarin?: boolean;
  aisLat?: number; aisLon?: number; aisSog?: number; aisCog?: number; aisHeading?: number; aisPosAt?: string;
  affectedBy?: string; affectRisk?: string; delay?: string; alertNote?: string;
};
