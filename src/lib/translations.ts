...
export const translations: Record<Language, TranslationSchema> = {
  en: {
    ...
    trust: {
      ...
      backedBy: "Supported by leading port innovation programmes",
      backedByItems: [
        { name: "La Lonja Tech", url: "https://lalonja.tech/" },
        { name: "Incubazul – BlueCore", url: "https://www.zfbluecore.es/" },
    ...
    footer: {
      ...
      tagline: "Where time in port becomes value. Built from the dock.",
    },
    about: aboutEn,
    legal: legalEn,
  },
  ...
  es: {
    ...
    trust: {
      ...
      backedBy: "Acompañado y respaldado por programas de innovación portuaria",
      backedByItems: [
        { name: "La Lonja Tech", url: "https://lalonja.tech/" },
        { name: "Incubazul – BlueCore", url: "https://www.zfbluecore.es/" },
        { name: "Santander X Explorer", url: "https://explorerbyx.org" },
    ...
    footer: {
      ...
      tagline: "Donde el tiempo en el puerto es valor. Construido desde el muelle.",
    },
    about: aboutEs,
    legal: legalEs,
  },
